...
export var wallSound = new soundFile("Breath+Wheeze.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("clockchime.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("clockgrand.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("feeling.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume

export var adventureMusic = new soundFile("feeling.mp3");
